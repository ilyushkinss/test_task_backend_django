...
- Создание, редактирование, удаление категорий и подкатегорий через админ-панель
...
### Продукты
- Создание, редактирование, удаление продуктов через админ-панель
- Продукты относятся к подкатегории и имеют: наименование, slug, цену
